...
<section class=" lg:px-16 bg-gray-50 dark:bg-gray-900">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900\ dark:text-white">
            <img class="w-12 h-12 mr-2" src="<?php echo e(asset('images/Hans_Store.png')); ?>" alt="Hans_Store">
            Hans Store
        </a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce\resources\views/auth/login.blade.php ENDPATH**/ ?>
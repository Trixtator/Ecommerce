    ...
    <div class="container px-4 mx-auto text-center">
        ...
        <div>
            <h1 class="text-3xl font-semibold text-[#] mb-6 pl-2">
                <a href="<?php echo e(route('home')); ?>" class="text-[#]">Home</a> / About Us
            </h1>
        </div>

        <!-- Image Section -->

        <img src="<?php echo e(asset('images/apple.jpg')); ?>" alt="About Us Image"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce\resources\views/aboutpage.blade.php ENDPATH**/ ?>
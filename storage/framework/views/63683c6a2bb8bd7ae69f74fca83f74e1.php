...
<div class="w-full max-w-2xl p-8 mx-auto bg-black rounded-lg shadow-lg">
    ...
    <div class="flex justify-center mb-6">
        <img src="<?php echo e(asset('images/Hans_Store.png')); ?>" alt="HansStore" class="object-contain w-20 h-20">
    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'password_confirmation','class' => 'block w-full px-4 py-2 border border-white rounded-md focus:outline-none focus:ring-2 focus:ring-[#ffffff] text-[#ffffff]','type' => 'password','name' => 'password_confirmation','required' => true,'autocomplete' => 'new-password','placeholder' => 'Confirm your password']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'password_confirmation','class' => 'block w-full px-4 py-2 border border-white rounded-md focus:outline-none focus:ring-2 focus:ring-[#ffffff] text-[#ffffff]','type' => 'password','name' => 'password_confirmation','required' => true,'autocomplete' => 'new-password','placeholder' => 'Confirm your password']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <p class="mt-4 text-center text-yellow-500">Already have an account?
        <a href="<?php echo e(route('login')); ?>" class="text-[#ffffff] hover:underline">Login here</a>
    </p>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce\resources\views/auth/register.blade.php ENDPATH**/ ?>
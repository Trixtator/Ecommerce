...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('images/Hans_Store.png')); ?>" type="image/png">
    <style>
        * {
            padding: 0;
            margin: 0;
...
<body class="text-gray-800 bg-gray-50">
    ...
    <header class="sticky top-0 z-50 w-full bg-white shadow-md">
        <div class="flex items-center justify-between w-full px-4 mx-auto max-w-7xl">
            ...
            <a class="text-3xl font-bold text-orange-500" href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('images/Hans_Store.png')); ?>" alt="Hans Store" class="h-12 lg:h-16">
            </a>
            ...
            <div class="flex items-center justify-between bg-gray-100 rounded-full lg:flex">
                <form action="<?php echo e(route('search')); ?>" method="GET" class="relative flex items-center">
                    <input type="search"
                        ...
                        placeholder="Your Favourite Phone....." name="search"
            ...
            <div class="items-center hidden space-x-8 lg:flex">
                ...
                <a href="<?php echo e(route('mycart')); ?>" class="relative text-gray-600 hover:text-[#000000]">
                    <i class='text-2xl bx bx-cart'></i>
                    <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->cart->count() > 0): ?>
                    <span
                        class="absolute top-0 right-0 flex items-center justify-center w-4 h-4 text-xs text-white bg-[#000000] rounded-full">
                ...
                <div class="relative group">
                    ...
                    <div class="relative inline-block">
                        ...
                        <?php else: ?>
                        <div
                            class="flex items-center justify-center w-10 h-10 text-white bg-[#000000] rounded-full cursor-pointer">
                    ...
                    <div
                        ...
                        <a href="<?php echo e(route('myorder')); ?>"
                            ...
                            <i class="bx bxs-shopping-bag text-[#00000] mr-2"></i> My Orders
                        </a>
                        <a href="<?php echo e(route('profile.edit')); ?>"
                            class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">
                            <i class="bx bxs-user text-[#000000] mr-2"></i> My Profile
                        </a>
                        <form action="<?php echo e(route('logout')); ?>" method="POST" class="w-full">
                            ...
                            <button type="submit"
                                ...
                                <i class="bx bxs-log-out-circle text-[#000000] mr-2"></i> Logout
                            </button>
                        </form>
                    </div>
                </div>
                ...
                <div class="hidden sm:block">
                    <span>
                        <a href="<?php echo e(route('login')); ?>" class="text-[#00000]"> <i class='bx bx-log-in'></i> Login</a>
                    </span>
                    <strong>/</strong>
                    <span>
        ...
        <div id="mobile-menu" class="hidden p-6 bg-white shadow-lg lg:hidden">
            <ul>
                <li><a href="#" class="block py-1 text-gray-600 hover:text-[#00000] border">Home</a>
                </li>
                <li><a href="#" class="block py-1 text-gray-600 hover:text-[#00000]">Shop</a></li>
                <li><a href="#" class="block py-1 text-gray-600 hover:text-[#00000]">Categories</a></li>
                <li><a href="#" class="block py-1 text-gray-600 hover:text-[#00000]">Contact</a></li>
                <li><a href="<?php echo e(route('mycart')); ?>" class="block py-1 text-gray-600 hover:text-[#00000]">MyCart</a>
                </li>

                <?php if(auth()->guard()->guest()): ?>
                <li><a href="<?php echo e(route('login')); ?>" class="block py-1 text-gray-600 hover:text-[#00000]">Login</a>
                </li>
                <li><a href="<?php echo e(route('register')); ?>"
                        class="block py-1 text-gray-600 hover:text-[#000000]">Register</a></li>
                <?php endif; ?>
                <?php if(auth()->guard()->check()): ?>
                <li><a href="<?php echo e(route('myorder')); ?>" class="block py-1 text-gray-600 hover:text-[#00000]">My
                        Orders</a></li>
                <li><a href="<?php echo e(route('profile.edit')); ?>" class="block py-1 text-gray-600 hover:text-[#000000]">My
                        Profile</a></li>
                <li>
                    <form action="<?php echo e(route('logout')); ?>" method="POST" class="w-full">
                        <?php echo csrf_field(); ?>
                        <button type="submit"
                            class="block py-1 text-gray-600 hover:text-[#0000] w-full text-left">Logout</button>
                    </form>
                </li>
                <?php endif; ?>
            </ul>
    ...
    <!-- Footer -->
    <footer class="px-8 py-8 bg-[#000000] text-white mt-10">
        <div class="max-w-screen-xl mx-auto">
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                <!-- Logo and Social Icons -->
                <div class="-ml-0 lg:-ml-10">
                    <a href="#" aria-label="Hans Store">
                        <img src="<?php echo e(asset('images/Hans_Store.png')); ?>" alt="Hans Store"
                ...
                <div class="-ml-0 lg:-ml-10">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li>
                            <a href="<?php echo e(route('whyHans_Store')); ?>"
                                class="text-sm transition-colors md:text-base hover:text-white">WhyHans_Store?</a>
                        </li>
                ...
                <div class="mb-8 -ml-0 lg:-ml-10 lg:mb-12">
                    ...
                    <ul class="space-y-3 lg:space-y-4">
                        ...
                        <li class="flex items-start lg:items-center">
                            ...
                            <a href="farhanfarajhuda@gmail.com"
                                class="mt-1 ml-2 text-sm transition-colors md:text-base hover:text-white">
                                farhanfarajhuda@gmail.com
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="flex flex-col items-center justify-between md:flex-row">
                ...
                <p class="text-sm text-center md:text-right">
                    © <?php echo e(date('Y')); ?> Ip Store. All rights reserved. | Developed by:
                    <a href="#" class="underline hover:text-gray-300">Hans Store</a>
                </p>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH C:\xampp\htdocs\ecommerce\resources\views/layouts/master.blade.php ENDPATH**/ ?>
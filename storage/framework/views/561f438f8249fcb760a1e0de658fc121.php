...
<div class="flex flex-col w-full max-h-screen overflow-y-auto ">
    ...
    <div class="flex items-center justify-around w-full mt-2 lg:justify-between">
        ...
        <a href="<?php echo e(route('category.create')); ?>" class="px-3 py-1 text-white bg-red-100 rounded-lg ">Add
        </a>
    </div>
            ...
            <table class="min-w-full text-gray-800 table-auto">
                ...
                <tbody>
                    ...
                    <tr class="transition duration-300 border-b bg-gray-50 hover:bg-blue-100">
                        ...
                        <td class="px-4 py-2 text-xs sm:px-6 sm:py-4 sm:text-sm md:text-base">
                            < src="<?php echo e(asset('images/categories/' . $category->photopath)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce\resources\views/category/index.blade.php ENDPATH**/ ?>
...
<body class="bg-gray-100">
    ...
    <div class="flex ">
        ...
        <!-- Sidebar -->
        <div id="sidebar"
            class="fixed lg:relative bg-[#000000] w-44 h-full lg:h-screen z-40 lg:block lg:translate-x-0 transform -translate-x-full transition-transform duration-300 ease-in-out text-white">
            <div class="flex items-center justify-center py-2 -mb-10">
                <img src="<?php echo e(asset('images/Hans_Store.png')); ?>" alt="Logo" class="w-24 h-24">
